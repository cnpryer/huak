...
/// ~/.profile
/// ~/.bashrc
pub fn _add_completion_bash() -> Result<(), Error> {
    ...
    file.write_all(
        r##"eval "$(huak config completion bash)""##
            .to_string()
            .as_bytes(),
    )?;
...
// TODO
pub fn _add_completion_elvish() -> Result<(), Error> {
    todo!()
}
...
pub fn _add_completion_fish(cli: &mut Command) -> Result<(), Error> {
    let home = match std::env::var("HOME") {
        Ok(dir) => dir,
        Err(e) => {
            // defaulting to root, this might not be the right call
...
// TODO
pub fn _add_completion_powershell() -> Result<(), Error> {
    todo!()
}

/// Zsh and fish are the same in the sense that the use an entire directory to collect shell init
/// scripts.
pub fn _add_completion_zsh(cli: &mut Command) -> Result<(), Error> {
...
pub fn _remove_completion_bash() -> Result<(), Error> {
    let home = match std::env::var("HOME") {
        Ok(dir) => dir,
        Err(e) => {
            // defaulting to root, this might not be the right call
...
// TODO
pub fn _remove_completion_elvish() -> Result<(), Error> {
    todo!()
}

pub fn _remove_completion_fish() -> Result<(), Error> {
    let home = match std::env::var("HOME") {
        Ok(dir) => dir,
        Err(e) => {
            // defaulting to root, this might not be the right call
...
// TODO
pub fn _remove_completion_powershell() -> Result<(), Error> {
    todo!()
}

pub fn _remove_completion_zsh() -> Result<(), Error> {
    let _target_file = "/usr/local/share/zsh/site-functions/_huak".to_string();
...
# removing the bash completion script", file_content)
    ...
    fn test_adding_completion_fish(cmd: &mut Command) {
        let _ = _add_completion_fish(cmd);
